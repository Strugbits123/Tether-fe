...
interface FinishProfileModalProps {
  ...
  readOnly?: boolean;
  /** Overrides the header title. Defaults to "Finish Your Profile" / "Your Profile" (readOnly). */
  title?: string;
      ...
      try {
        ...
        setStatus(
          user.relationship_status
            ? STATUS_TO_LABEL[user.relationship_status] || ""
            : "",
        );
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (avatarFile) {
        ...
        const { signedUploadUrl, publicUrl } = await getAvatarUploadUrl(
          token,
          avatarFile.type,
        );
      ...
      await updateProfile(token, {
        ...
        relationship_status: status
          ? STATUS_TO_VALUE[status] || undefined
          : undefined,
      ...
      >
        ...
        >
          ...
          <div className={embedded ? "pt-6 sm:pt-[37px] px-4 sm:px-6" : "pt-6 sm:pt-[37px] px-4 sm:px-6 pr-12 sm:pr-14"}>
            ...
            >
              {title ?? (readOnly ? "Your Profile" : "Finish Your Profile")}
            </h2>
            <p
              className="mt-2"
              style={{
                  ...
                  <div>
                    ...
                    {!hideSmsOptIn && phone.trim().length > 0 && (
                      <label className="flex items-start gap-2 mt-3 cursor-pointer">
                        ...
                        >
                          Send me important account updates by text — including
