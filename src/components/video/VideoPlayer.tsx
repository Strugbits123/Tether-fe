 ...
 */
export default function VideoPlayer({ playbackId, playbackToken, autoPlay = false }: VideoPlayerProps) {
  return (
    <div className="w-full overflow-hidden" style={{ borderRadius: 12, background: '#000000' }}>
      <MuxPlayer
