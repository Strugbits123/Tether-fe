      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center" style={{ gap: 16 }}>
          ...
          <button
            ...
            style={{ width: 56, height: 56, borderRadius: '50%', background: '#EF4444' }}
          >
            {isPlaying ? (
              <Pause className="w-6 h-6 text-white" fill="white" strokeWidth={0} />
            ) : (
              <Play className="w-6 h-6 text-white" fill="white" strokeWidth={0} style={{ marginLeft: 2 }} />
            )}
          </button>
          <button
            type="button"
        ...
        <div className="flex items-center" style={{ gap: 8, minWidth: 84 }}>
          <Volume2 className="w-4 h-4 text-[#6B7280] flex-shrink-0" strokeWidth={2} />
          <input
            type="range"
            min={0}
            max={1}
...
function SkipBack15() {
  return (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      />
      <text x="11.5" y="11" fontSize="7" fontWeight="700" fill="#374151" fontFamily="Inter, sans-serif">
        15
      </text>
    </svg>
  )
  ...
  return (
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        ...
        strokeLinejoin="round"
      />
      <text x="5.5" y="11" fontSize="7" fontWeight="700" fill="#374151" fontFamily="Inter, sans-serif">
        15
      </text>
    </svg>
  )
