...
const CATEGORIES: {
  ...
  totalDenom?: number;
  apiKey: string;
  tooltip: { description: string; tags: string[] };
}[] = [
  {
    key: "legal",
    label: "Legal",
    ...
    tooltip: {
      description:
        "Official documents that define your wishes and protect your estate after you're gone.",
      tags: [
        "Last will & testament",
        "Living trust",
        "Power of attorney",
  ...
  },
  {
    ...
    tooltip: {
      description:
        "Records of your money, accounts, and debts so your family knows exactly what exists and where to find it.",
      tags: [
        "Bank account info",
        "Investment accounts",
        "Retirement plans",
  ...
  },
  {
    ...
    tooltip: {
      description:
        "Policies that pay out or protect your family — your executor needs these to file claims on your behalf.",
      tags: [
        "Life insurance",
        "Health insurance",
        "Auto insurance",
  ...
  },
  {
    ...
    tooltip: {
      description:
        "Proof of ownership for everything you own so your estate can be properly and legally settled.",
      tags: [
        "Home deed",
        "Vehicle titles",
        "Mortgage docs",
  ...
  },
  {
    ...
    bg: "#DBEAFE",
    color: "#155DFC",
    apiKey: "digital_accounts",
    tooltip: {
      description:
        "Your online accounts and digital assets — without this your family may lose access to them permanently.",
      tags: [
        "Email accounts",
        "Social media",
        "Subscriptions",
...
const FULL_CATEGORY_MAP: Record<
  string,
  { bg: string; color: string; label: string; icon: typeof Scale }
> = {
      ...
      >
        ...
        >
          {CATEGORIES.map((cat) => {
            ...
            const isTooltipOpen = openTooltip === cat.key;
            return (
              <button
                key={cat.key}
                type="button"
              ...
              >
                ...
                >
                  {count}
                  {cat.totalDenom && (
                    <span style={{ color: "#99A1AF", fontSize: 18 }}>
                      {" "}
                      / {cat.totalDenom}
                    </span>
                  )}
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className="flex flex-col px-6 sm:px-8 pt-6 sm:pt-8 pb-6 sm:pb-8"
            style={{ gap: 28 }}
          >
            {/* Header */}
            ...
            >
              ...
              <Cell label="Access">
                <span className="flex items-center" style={{ gap: 6 }}>
                  ...
                  {doc.assignments.length === 1 ? "Recipient" : "Recipients"}
                </span>
              </Cell>
            </div>
...
function EditDocumentModal({
  ...
  const { showToast } = useToast();
  const { groups: initGroups, individuals: initIndividuals } =
    assignmentsToSelections(doc.assignments);
  ...
  const [selectedIndividuals, setSelectedIndividuals] =
    useState<string[]>(initIndividuals);
